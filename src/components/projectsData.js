export const PROJECT_DETAIL = {
  'Slope Ninja': {
    ...
    longSkills: ['React', 'React Native', 'DynamoDB', 'node.js', 'PostgreSQL', 'Knex', 'Koa', 'Bootstrap Grid', 'Redux', 'Sketch', 'UI/UX'],
  },
  NDAify: {
    title: 'NDAify',
    description: 'NDA-walls for your business secrets',
    subDescription: 'Web',
    shortSkills: ['React', 'Stripe API', 'OAuth', 'Next.js', '...', 'UI/UX'],
    longSkills: ['React', 'Stripe API', 'OAuth', 'Next.js', 'node.js', 'Koa', 'DynamoDB', 'AWS SES', 'Swagger', 'Figma', 'UI/UX'],
  },
  Trulia: {
    title: 'Trulia',
    description: 'Real estate listings and rental properties',
    subDescription: 'Web',
    shortSkills: ['React', 'GraphQL', 'Apollo', '...', 'TypeScript'],
    longSkills: ['React', 'GraphQL', 'Apollo', 'PHP', 'Redux', 'Next.js', 'TypeScript'],
